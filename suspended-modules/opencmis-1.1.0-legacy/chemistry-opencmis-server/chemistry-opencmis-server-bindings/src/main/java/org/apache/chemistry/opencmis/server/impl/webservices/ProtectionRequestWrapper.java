...
public class ProtectionRequestWrapper extends HttpServletRequestWrapper {
    ...
    class CheckServletInputStream extends ServletInputStream {
        ...
        public void setReadListener(jakarta.servlet.ReadListener readListener) {
            // Jakarta Servlet API 6.0.0 requirement
            // This is for async I/O - not implemented in this protection wrapper
            throw new UnsupportedOperationException("Async I/O not supported in ProtectionRequestWrapper");
        }
