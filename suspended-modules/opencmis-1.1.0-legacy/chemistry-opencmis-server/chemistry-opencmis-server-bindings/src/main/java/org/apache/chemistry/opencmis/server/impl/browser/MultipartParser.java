...
public class MultipartParser {
    ...
    private void extractBoundary() {
        ...
        System.err.println("*** MULTIPART PARSER DEBUG: extractBoundary() called");
        System.err.println("*** MULTIPART PARSER DEBUG: Request Content-Type: '" + requestContentType + "'");

        // parse content type and extract boundary
        byte[] extractedBoundary = MimeHelper.getBoundaryFromMultiPart(requestContentType);
        System.err.println("*** MULTIPART PARSER DEBUG: MimeHelper.getBoundaryFromMultiPart() returned: " + 
            (extractedBoundary != null ? "byte array length " + extractedBoundary.length : "null"));
        
        if (extractedBoundary == null) {
            System.err.println("*** MULTIPART PARSER DEBUG: CRITICAL FAILURE - Throwing CmisInvalidArgumentException");
            System.err.println("*** MULTIPART PARSER DEBUG: This indicates boundary extraction failed in MimeHelper");
            throw new CmisInvalidArgumentException("Invalid multipart request!");
        }
        
        System.err.println("*** MULTIPART PARSER DEBUG: Boundary extraction successful, proceeding with parsing");
