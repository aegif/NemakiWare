...
### 21 巡目 (Codex + サブエージェント、並行) — Codex P2 1・P3 1、サブ P2 1・P3 4 (本文の
列挙どおり。サブの報告は 5 件立てだが、うち 1 件は本文で 2 つに分けた文面の指摘)、`NOT CONVERGED`
...
### 22 巡目 (Codex + サブエージェント、並行) — 両者 P2 (同一 1 + Codex 2)・P3 8、`NOT CONVERGED`
...
- **P2 (両者・同一) — WO が、同じコミットで新設した錠 1 本をまた宣言していない**
  ...
  (緑の 3 本のうち 2 本は第 2 呼び出し口ではなく「無効と読まれるので報告されない」から)。
