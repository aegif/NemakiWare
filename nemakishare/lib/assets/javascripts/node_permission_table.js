...
$(function() {
	...
	var userColNames = [ "ユーザ/グループID" ];
	// CREATE
	createUserTable();
	function createUserTable() {
		var tableParams_user = $.extend(true, {}, baseTableParams);
		tableParams_user.caption = "ユーザ検索結果";
	...
	function createLocalAclTable() {
		...
		tableParams_localAcl.caption = "ローカルで設定された権限";
