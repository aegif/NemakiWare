 ...
 */
@Disabled("Test assertions do not match API implementation contract (parentId is @QueryParam, not JSON body; response shape differs). Needs full rewrite against actual API.")
