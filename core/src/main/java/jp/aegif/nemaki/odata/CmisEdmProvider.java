...
public class CmisEdmProvider extends CsdlAbstractEdmProvider {
    ...
    // Additional Entity Types for Types, Users, Groups
    ...
    private CsdlEntityType createUserEntityType() {
        ...
        properties.add(createProperty("created", EdmPrimitiveTypeKind.DateTimeOffset, true));
        properties.add(createProperty("modified", EdmPrimitiveTypeKind.DateTimeOffset, true));
        entityType.setProperties(properties);
    ...
    private CsdlEntityType createGroupEntityType() {
        ...
        navProperties.add(createNavigationProperty("subGroups", ET_GROUP_FQN, true));
        entityType.setNavigationProperties(navProperties);
