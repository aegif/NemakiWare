...
function getTooltipContentHTML() {
  return (
    /*html*/
    `
    <slot name="tooltip-enable">${(0, import_i18n.t)("Enable captions")}</slot>
    <slot name="tooltip-disable">${(0, import_i18n.t)("Disable captions")}</slot>
  `
  );
}
...
class MediaCaptionsButton extends import_media_chrome_button.MediaChromeButton {
  ...
  connectedCallback() {
    ...
    this.setAttribute("aria-label", (0, import_i18n.t)("closed captions"));
