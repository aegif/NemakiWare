...
CONTROLS = [
    ...
    dict(
        ...
        expect_fail=['anIncompleteWalkPublishesChangesButReconcilesNothing',
                     'aPartialPublishKeepsThePreviousSnapshot',
                     'aPartiallyPublishedRoundWidensOnlyWhatLanded',
                     'anIncompleteWalkWidensTheSnapshotWithWhatItPublished'],
    ),
    dict(
        id="HD",
    ...
    dict(
        ...
        expect_fail=['aHugeMaxItemsDoesNotOverflow',
                     'aResumedZeroAskStillPagesFully',
                     'anOutOfRangeMaxItemsIsClamped'],
    ),
    dict(
        id="IC",
    ...
    dict(
        ...
        expect_fail=['aFailedLivenessProbeRefuses',
                     'aClientlessLivenessProbeRefuses',
                     'aCountlessLivenessProbeRefuses'],
    ),
    dict(
        id="JP",
    ...
    dict(
        ...
        expect_fail=['aCompleteWalkKeepsFailedDocumentsChangedInTheBaseline',
                     ...
                     'aDocumentWhoseEntityFailedDoesNotEnterTheBaselineOnAMixedCount'],
    ),
    dict(
        id="KA",
    ...
    dict(
        ...
        expect_fail=['aDocumentWhoseEntityFailedDoesNotEnterTheBaselineOnAMixedCount',
                     'aCompleteWalkDropsAFailedNewDocumentFromTheBaseline',
                     'aCompleteWalkKeepsFailedDocumentsChangedInTheBaseline'],
    ),
    dict(
        id="KH",
    ...
    dict(
        ...
        expect_fail=['aFailedExpirationSweepRefuses',
                     'anUnansweredRetentionViewRefuses'],
    ),
    dict(
        id="LB",
    ...
    dict(
        ...
        expect_fail=['anUnreadableVersionIsReportedByTheFilesystemExport',
                     ...
                     'aMidCopyVersionFailureLeavesNoPartialFile',
                     'aRefusedVersionLeavesNoFile',
                     'aVersionFailureBeforeOpeningKeepsAnExistingFile'],
    ),
    dict(
        id="ML",
    ...
    dict(
        ...
        expect_fail=['aMissingMethodRaisesHarnessBroken',
                     'noTestStillReportsBreakageAsAnAssertion'],
    ),
    dict(
        id="MT",
    ...
    dict(
        ...
        expect_fail=['aMidCopyFailureDoesNotDestroyThePreviousExport',
                     'aMidCopyVersionFailureDoesNotDestroyThePreviousExport',
                     'aMidCopyFailureLeavesNoPartialFile',
                     'aMidCopyVersionFailureLeavesNoPartialFile'],
    ),
    dict(
        id="NN",
    ...
    dict(
        ...
        expect_fail=['aSuccessfulOverwriteStillReplacesTheFile',
                     'anOverwrittenSidecarIsReplacedToo'],
    ),
    dict(
        id="NU",
    ...
    dict(
        ...
        expect_fail=['aConflictedRetirementIsReportedNotSwallowed',
                     'aNonTombstone409IsStillAFailure'],
    ),
    dict(
        id="OX",
    ...
    dict(
        ...
        expect_fail=['anUpdateOverAnInvisibleLegacyRowRefusesRetryably',
                     'aBoundaryRowIsCountedExactlyOnce',
                     'anUpdateWhoseScanCannotReadRefusesRetryablyToo',
                     'anUpdateWithAHiddenTwinIsAStandingPairNotARetry',
                     'anUpdateWithTwoVisibleTwinsDoesNotWrite'],
    ),
    dict(
        id="PH",
    ...
    dict(
        ...
        expect_fail=['aCreateStillWorksWhenTheScanFindsNothing',
                     'anUpdateWithACleanScanStillWrites'],
    ),
    dict(
        id="PN",
    ...
    dict(
        ...
        expect_fail=['aHiddenDefaultProfileStillBlocksASecondDefault',
                     'aCreateWhoseSelectorOutReportsTheWalkRefuses',
                     'aRowTheRuleCanReadStillCountsForTheRule',
                     'aRowWithoutAProfileIdRefusesTheListing'],
    ),
    dict(
        id="PX",
        ...
        expect_fail=['aHiddenProfileIsA503OnPut',
                     'aHiddenProfileIsA503OnDelete',
                     'aHiddenProfileIsA503OnGet',
                     'aHiddenProfileIsA503OnOwnershipTransfer',
                     'aPairInThisRepositoryIsA409NotAChoice',
                     'anUnreadableIndexFreeReadIsA503OnPut'],
    ),
    dict(
        id="PY",
    ...
    dict(
        ...
        expect_fail=['thePlainDeleteRemovesHiddenTwinsToo',
                     ...
                     'aPartlyFailedDeleteSaysHowMuchWasRemoved'],
    ),
    dict(
        id="QG",
    ...
    dict(
        ...
        test='ImportProfileLegacyIdMigrationTest',
        expect_fail=['theAutoResolverSeesAHiddenDefault',
                     'theAutoResolverRefusesAnUnreadableRow',
                     'aBrokenIndexDoesNotRefuseTheAutoResolver',
                     ...
                     'aDisabledRowTheResolverCannotReadDoesNotRefuseTheResolve',
                     'aLegacyRowTheMigrationCouldNotRewriteIsStillTheDefault',
                     'anEnabledRowTheResolverCannotInterpretStillRefuses'],
    ),
    dict(
        id="QD",
    ...
    dict(
        ...
        expect_fail=['theResolverIsAdminOnly',
                     'theRowAddressedDeleteIsAudited'],
    ),
    dict(
        id="QF",
    ...
    dict(
        ...
        expect_fail=['aRefusedDeleteLeavesImapIdleRunning',
                     'aConfinedDeleteLeavesAnotherRepositorysSchedulerAlone',
                     'aDeleteThatLeftNothingStopsTheScheduler',
                     'aFailingStopIdleDoesNotLoseTheAudit',
                     'aPlainDeleteWithAnUnknownCountSaysSo',
                     ...
                     'aSharedProfileIdDoesNotLockThisRepositoryOut',
    ...
    dict(
        ...
        expect_fail=['aDeterministicRowTheIndexCannotShowIsStillFoundByGet',
                     'aCreateRefusesWhenTheDeterministicRowIsHidden',
    ...
    dict(
        ...
        expect_fail=['twoLegacyRowsForOneIdAreBothLeftStanding',
                     'legacyRowsInDifferentRepositoriesLeaveTheDeterministicRowAlone',
    ...
    dict(
        ...
        expect_fail=['aHiddenProfileIsA503OnGet',
                     'theReadVerbsStillConfineToTheRepository'],
    ),
    dict(
        id="RM",
        ...
        test='ConnectorLegacyIdMigrationTest',
        expect_fail=['existsIndexFreeSeesHiddenRowsAndRefusesUnreadableOnes',
                     'aTransportFailureOnTheWalkIsTypedNotReady'],
    ),
    dict(
        id="RN",
    ...
    dict(
        ...
        expect_fail=['theReadVerbsReachThisRepositorysRow',
                     ...
                     'anUnattributableSessionIsStopped',
                     'anUnreadableIndexFreeReadIsA503OnPut',
                     'thePlainDeleteCarriesTheRepositoryAndRefusesRetryably'],
    ),
    dict(
        id="SW",
    ...
    dict(
        ...
        expect_fail=['initDeclaresTheStartupWindow',
                     'aFailedFirstInitDoesNotSpendTheGrace',
                     'aLaterInitDoesNotOpenTheWindow'],
    ),
    dict(
        id="MP",
    ...
    dict(
        ...
        expect_fail=['aNewlineCrossingTenantAndAuthTypeIsNotTheSameConnection',
                     'aNewlineCrossingIdentityChangeStopsLiveAdmission',
                     'aNullAndBlankTenantIdAreNotTheSameConnection'],
    ),
    dict(
        id="UR",
    ...
    dict(
        ...
        expect_fail=['theRecipientsAreReadFromTheWalkNotTheSelector',
                     'aBrokenRowOfAnotherConnectorDoesNotStopTheDispatch',
    ...
    dict(
        ...
        expect_fail=['theSelectorListingPagesPastTheFirstPage',
                     'theSelectorListingRefusesABookmarkCycle',
                     'theSelectorListingRefusesAFullPageWithoutABookmark',
                     'theSelectorListingRefusesAListingThatDidNotAnswer'],
    ),
    dict(
        id="WC",
    ...
    dict(
        ...
        expect_fail=['aDisabledRowTheResolverCannotReadDoesNotRefuseTheResolve',
                     'aDisabledByStringRowTheResolverCannotReadDoesNotRefuseTheResolve',
                     'aDisabledByNullRowTheResolverCannotReadDoesNotRefuseTheResolve',
                     'aDisabledRowWithoutAProfileIdDoesNotBlockACreate'],
    ),
    dict(
        id="WJ",
    ...
    dict(
        ...
        expect_fail=['aRecipientRowThatCannotBeInterpretedIsA503NotNoProfile',
                     ...
                     'aRecipientRowNamedThroughAllowedConnectorsIsRefusedToo'],
    ),
    dict(
        id="YD",
        ...
        expect_fail=['aRecipientRowThatCannotBeInterpretedIsA503NotNoProfile',
                     ...
                     'aRecipientRowNamedThroughAllowedConnectorsIsRefusedToo',
                     'aRowWhoseAddresseeCannotBeReadRefusesEveryConnectorsDispatch',
                     'anUnwiredProfileServiceIsA503NotNoProfile'],
    ),
    dict(
        id="WO",
    ...
    dict(
        ...
        test='ConnectorLegacyIdMigrationTest',
        expect_fail=['theSelectorListingRefusesAFullPageWithoutABookmark',
                     'anSdkIllegalStateExceptionIsLoggedWithItsCause'],
    ),
    dict(
        id="WW",
    ...
    dict(
        ...
        expect_fail=['aConnectorReadThatCouldNotBeAnsweredIsA503NotA401',
                     ...
                     'aBrokenRowWhoseArchetypesExcludeTheConnectorDoesNotStopTheDispatch',
                     'aBrokenRowWhoseConnectorFieldsCannotBeReadButWhoseArchetypesExcludeTheConnectorDoesNotStopTheDispatch',
                     'aListingThatCannotBeCompletedIsA503NotNoProfile',
                     'aRecipientRowNamedThroughAllowedConnectorsIsRefusedToo',
                     'aRecipientRowThatCannotBeInterpretedIsA503NotNoProfile',
                     'aRowWhoseAddresseeCannotBeReadRefusesEveryConnectorsDispatch',
                     'anUnwiredProfileServiceIsA503NotNoProfile',
                     'boxEvent_fileUploaded_validSignature_triggersFetch',
    ...
    dict(
        ...
        expect_fail=['aDeleteThatRemovedNothingIsNotSuccess',
                     ...
                     'aDeleteThatFoundNoRowDoesNotSayRetry'],
    ),
    dict(
        id="VH2",
    ...
    dict(
        ...
        # that stubs only getOwnedRowIndexFree gets "Profile not found" instead of its
        # own refusal.
        expect_fail=['aFolderOrAclReadThatFailedIsNotARevocation',
                     'aDelegatedAuthorisationThatCouldNotBeAskedIsNotARevocation',
                     'aStartWhoseDelegatedAuthorisationCouldNotBeAskedIsNotADenial'],
    ),
    dict(
        id="VY2",
    ...
    dict(
        id="ZB2",
        what='the two R11 reasons drop out of the could-not-ask predicate, so a folder or ACL read that failed stops IDLE for good',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestSchedulerService.java',
        find='                || why == DenialReason.SERVICES_UNAVAILABLE\n                || why == DenialReason.TARGET_FOLDER_LOOKUP_FAILED\n                || why == DenialReason.CREATOR_CMIS_ALL_LOOKUP_FAILED;',
        replace='                || why == DenialReason.SERVICES_UNAVAILABLE;',
        test='ImapIdleSessionRegistryTest',
        expect_fail=['aFolderOrAclReadThatFailedIsNotARevocation'],
    ),
    dict(
        id="ZC2",
        what='the delegated tick lets a folder read that FAILED escape instead of recording it as could-not-ask',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestSchedulerService.java',
        find='        } catch (IngestAuthorizationService.AuthorizationReadFailedException couldNotAsk) {\n            // Not "no longer resolvable": the read did not answer.',
        replace='        } catch (ArithmeticException couldNotAsk) {\n            // Not "no longer resolvable": the read did not answer.',
        test='IngestSchedulerDelegatedRunTest',
        expect_fail=['aTargetFolderReadThatFailedIsNotUnresolvable'],
    ),
    dict(
        id="ZD2",
        what='the delegated tick lets a cmis:all evaluation that FAILED escape instead of recording it as could-not-ask',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestSchedulerService.java',
        find='        } catch (IngestAuthorizationService.AuthorizationReadFailedException couldNotAsk) {\n            // Not "no longer holds": the folder, its ACL or the groups could not be read.',
        replace='        } catch (ArithmeticException couldNotAsk) {\n            // Not "no longer holds": the folder, its ACL or the groups could not be read.',
        test='IngestSchedulerDelegatedRunTest',
        expect_fail=['aCmisAllReadThatFailedIsNotALoss'],
    ),
    dict(
        id="ZE2",
        what='the refusing path read answers null for a store that did not answer, like the swallowing one',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestAuthorizationService.java',
        find='            throw new AuthorizationReadFailedException("the target folder path \'" + folderPath',
        replace='            if (true) return null;\n            throw new AuthorizationReadFailedException("the target folder path \'" + folderPath',
        test='IngestAuthorizationServiceTest',
        expect_fail=['resolveFolderIdOrRefuse_refusesWhenThePathReadThrows'],
    ),
    dict(
        id="ZF2",
        what='the refusing cmis:all read answers false for a folder read that did not answer',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestAuthorizationService.java',
        find='            throw new AuthorizationReadFailedException("folder " + folderId + " of repository "',
        replace='            if (true) return false;\n            throw new AuthorizationReadFailedException("folder " + folderId + " of repository "',
        test='IngestAuthorizationServiceTest',
        expect_fail=['canManageOrRefuse_refusesWhenTheFolderReadThrows'],
    ),
    dict(
        id="ZG2",
        what='a refused archetype listing escapes the resolution again and ends the poll\'s tick',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestSchedulerService.java',
        find='                } catch (ConnectorDefinitionServiceImpl.ConnectorIndexNotReadyException refused) {\n                    // The listing refused.',
        replace='                } catch (ArithmeticException refused) {\n                    // The listing refused.',
        test='IngestSchedulerControllerAnswerTest',
        expect_fail=['aListingThatRefusedIsNotAnAnswer'],
    ),
    dict(
        id="ZH2",
        what='the walk\'s transport refusal loses its type, so a create answers 400 for a walk that never ran',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/NemakiConfAllDocs.java',
        find='                throw new WalkDidNotAnswerException("the _all_docs listing of \'" + dbName\n                        + "\' could not be read, so whether the rows are there cannot be"',
        replace='                throw new IllegalStateException("the _all_docs listing of \'" + dbName\n                        + "\' could not be read, so whether the rows are there cannot be"',
        test='DefinitionCreateWalkFailuresAreRetriesTest',
        expect_fail=['aConnectorCreateWhoseWalkDidNotAnswerIsARetry', 'aProfileCreateWhoseRuleWalkDidNotAnswerIsARetry', 'aProfileCreateWhoseCountWalkDidNotAnswerIsARetry'],
    ),
    dict(
        id="ZI2",
        what='the connector create keeps its 400 for a walk that did not answer',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/ConnectorDefinitionServiceImpl.java',
        find='        return creating && !(unprovable instanceof NemakiConfAllDocs.WalkDidNotAnswerException);',
        replace='        return creating;',
        test='DefinitionCreateWalkFailuresAreRetriesTest',
        expect_fail=['aConnectorCreateWhoseWalkDidNotAnswerIsARetry'],
    ),
    dict(
        id="ZJ2",
        what='the profile create keeps its 400 for a walk that did not answer',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/ImportProfileDefinitionServiceImpl.java',
        find='        return creating && !(unprovable instanceof NemakiConfAllDocs.WalkDidNotAnswerException);',
        replace='        return creating;',
        test='DefinitionCreateWalkFailuresAreRetriesTest',
        expect_fail=['aProfileCreateWhoseRuleWalkDidNotAnswerIsARetry', 'aProfileCreateWhoseCountWalkDidNotAnswerIsARetry'],
    ),
    dict(
        id="ZK2",
        what='the retry door no longer refuses a webhook delivery record by its mark',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestDlqController.java',
        find='            if (dlq.isWebhookDeliveryRecord()) {',
        replace='            if (false) {',
        test='DlqRetryRefusalStatusTest',
        expect_fail=['aWebhookDeliveryRecordIsNotReplayed'],
    ),
    dict(
        id="ZL2",
        what='the service writes the record row without its mark',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestJobService.java',
        find='            dlq.setWebhookDeliveryRecord(webhookDeliveryRecord);',
        replace='            dlq.setWebhookDeliveryRecord(false);',
        test='IngestStoreAnswersAreNotAbsenceTest',
        expect_fail=['aWebhookDeliveryRecordSaveWritesTheMark'],
    ),
    dict(
        id="ZM2",
        what='the record helper claims a row whenever the call returned',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/FetchSupport.java',
        find='            return ingestJobService.saveWebhookDeliveryRecordToDlq(request, errorMessage);',
        replace='            ingestJobService.saveWebhookDeliveryRecordToDlq(request, errorMessage);\n            return true;',
        test='FetchSupportDlqTest',
        expect_fail=['saveWebhookDeliveryRecordToDlqReportsTheServicesAnswer'],
    ),
    dict(
        id="ZN2",
        what='the receiver records the misses through the unmarked helper again, so the row is replayable',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestWebhookController.java',
        find='            recorded = fetchSupport.saveWebhookDeliveryRecordToDlq(missed, why);',
        replace='            recorded = fetchSupport.saveSourceNeverReadToDlq(missed, why);',
        test='IngestWebhookBoxDropboxTest',
        expect_fail=['anAuthorisationThatCouldNotBeAskedIsRecordedAsAWebhookDeliveryRecord', 'aFetchThatCouldNotReadItsConfigurationIsRecorded'],
    ),
    dict(
        id="ZO2",
        what='the async fetch drops a configuration read that failed with only a log line again',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestWebhookController.java',
        find='            } catch (jp.aegif.nemaki.rest.controller.IntegrationSettingsService\n                    .SettingUnreadableException couldNotAsk) {\n                // The sender has its 200 and will not retry.',
        replace='            } catch (ArithmeticException couldNotAsk) {\n                // The sender has its 200 and will not retry.',
        test='IngestWebhookBoxDropboxTest',
        expect_fail=['aFetchThatCouldNotReadItsConfigurationIsRecorded'],
    ),
    dict(
        id="ZP2",
        what='an unwired property manager answers \'no access token\' again',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestWebhookController.java',
        find='        if (propertyManager == null) {\n            // Unwired answered null, and the caller said "No access token"',
        replace='        if (false) {\n            // Unwired answered null, and the caller said "No access token"',
        test='IngestWebhookBoxDropboxTest',
        expect_fail=['anUnwiredPropertyManagerDoesNotAnswerNoAccessToken'],
    ),
    dict(
        id="ZQ2",
        what='an unwired settings service is \'no idempotency record\' again, so a replace deletes the earlier document',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/CanonicalImportServiceImpl.java',
        find='                    } else {\n                        // Unwired is not "no record"',
        replace='                    } else if (false) {\n                        // Unwired is not "no record"',
        test='CanonicalImportServiceTest',
        expect_fail=['anUnwiredSettingsServiceIsNotNoIdempotencyRecord'],
    ),
    dict(
        id="ZR2",
        what='an unwired checkpoint store answers \'never polled\' (null) again',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/CheckpointManager.java',
        find='        if (settingsService == null) throw notWired(profileId + "/" + scope);',
        replace='        if (settingsService == null) return null;',
        test='CheckpointManagerTest',
        expect_fail=['loadSimple_refusesWhenUnwired'],
    ),
    dict(
        id="ZS2",
        what='an unwired checkpoint store answers \'never polled\' ({0, 0}) again for IMAP',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/CheckpointManager.java',
        find='        if (settingsService == null) throw notWired(profileId + "/" + mailboxFolder + " (IMAP)");',
        replace='        if (settingsService == null) return new long[]{0, 0};',
        test='CheckpointManagerTest',
        expect_fail=['loadValidity_refusesWhenUnwired'],
    ),
    dict(
        id="ZT2",
        what='a permission denial on the target folder path is folded into the retryable arm again',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/CanonicalImportServiceImpl.java',
        find='            } catch (org.apache.chemistry.opencmis.commons.exceptions.CmisPermissionDeniedException denied) {\n                // The store ANSWERED: the importing user may not read this path.',
        replace='            } catch (ArithmeticException denied) {\n                // The store ANSWERED: the importing user may not read this path.',
        test='IngestEvidenceSnapshotTest',
        expect_fail=['aTargetFolderPathTheUserMayNotReadIsNotARetry'],
    ),
    dict(
        id="ZU2",
        what='the classifier no longer maps the target-folder permission denial to 403',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/ExternalIngestController.java',
        find='                || firstError.contains("permission denied for the importing user")\n',
        replace='',
        test='IngestEvidenceSnapshotTest',
        expect_fail=['aTargetFolderPathTheUserMayNotReadIsNotARetry'],
    ),
    dict(
        id="ZW2",
        what='a delete the store did not answer escapes the single delete raw again (a 500 at the endpoint)',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestJobService.java',
        find='            } catch (RuntimeException couldNotAsk) {\n                // Raw, this reached the DELETE endpoint as a Spring 500',
        replace='            } catch (ArithmeticException couldNotAsk) {\n                // Raw, this reached the DELETE endpoint as a Spring 500',
        test='IngestStoreAnswersAreNotAbsenceTest',
        expect_fail=['aDeleteTheStoreDidNotAnswerIsATypedRefusal'],
    ),
    dict(
        id="ZX2",
        what='the trigger endpoint loses its arm for a refused listing and answers 400 \'no compatible connector\'',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestSchedulerController.java',
        find='            case LISTING_REFUSED -> {\n                // Without this arm the default below answered 400 "no connector" for a\n                // listing that never ran (R29).\n                response.put("message", "the connectors of profile " + profile.getProfileId()\n                        + " could not be listed while the index is not ready; retry shortly");\n                return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(response);\n            }\n',
        replace='',
        test='IngestSchedulerControllerAnswerTest',
        expect_fail=['aRefusedListingIs503OnTrigger'],
    ),
    dict(
        id="ZY2",
        what='the folder run endpoint loses its arm for a refused listing and answers 400 \'no connector resolved\'',
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/FolderConnectorController.java',
        find='            case LISTING_REFUSED -> {\n                // Without this arm the default below answered 400 "no connector" for a\n                // listing that never ran (R29).\n                body.put("message", "the connectors of profile " + profile.getProfileId()\n                        + " could not be listed while the index is not ready; retry shortly");\n                return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(body);\n            }\n',
        replace='',
        test='FolderConnectorControllerTest',
        expect_fail=['aRefusedListingIs503OnRun'],
    ),
    dict(
        id="AH3",
        what="the cleanup after a replay that landed lets the store's refusal fall into the "
             "catch-all again, so the import that succeeded is reported as 'Retry failed' (500)",
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestDlqController.java',
        find='        } catch (IngestJobService.IngestStoreDidNotAnswerException couldNotAsk) {\n            response.put("entryKeptNote", "the import landed, but the store did not answer the"',
        replace='        } catch (ArithmeticException couldNotAsk) {\n            response.put("entryKeptNote", "the import landed, but the store did not answer the"',
        test='DlqRetryRefusalStatusTest',
        expect_fail=['aCleanupTheStoreDidNotAnswerKeepsTheEntry'],
    ),
    dict(
        id="AI3",
        what="the 404 for a delete that found no row tells the caller to retry again",
        file='core/src/main/java/jp/aegif/nemaki/rest/ingest/IngestDlqController.java',
        find='                    + " was returned to delete; nothing was deleted. If the entry is still"\n                    + " listed, the index has not caught up with it yet");',
        replace='                    + " was returned to delete; nothing was deleted. If the entry is still"\n                    + " listed, the index has not caught up with it yet, so retry");',
        test='DlqRetryRefusalStatusTest',
