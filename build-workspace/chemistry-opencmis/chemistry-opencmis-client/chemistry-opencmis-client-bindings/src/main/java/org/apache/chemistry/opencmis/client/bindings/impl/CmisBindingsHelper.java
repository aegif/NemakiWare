    ...
    public static CmisSpi getSPI(BindingSession session) {
        ...
        try {
            ...
            try {
                ...
                System.err.println("=== SPI SELECTION DEBUG ===");
                System.err.println("BINDING_SPI_CLASS requested: " + spiName);
                System.err.println("Attempting to load SPI class: " + spiName);
                Constructor<?> c = ClassLoaderUtil.loadClass(spiName).getConstructor(BindingSession.class);
                spi = (CmisSpi) c.newInstance(session);
                System.err.println("SPI LOADED SUCCESSFULLY: " + spi.getClass().getName());
                System.err.println("=== SPI SELECTION COMPLETE ===");
