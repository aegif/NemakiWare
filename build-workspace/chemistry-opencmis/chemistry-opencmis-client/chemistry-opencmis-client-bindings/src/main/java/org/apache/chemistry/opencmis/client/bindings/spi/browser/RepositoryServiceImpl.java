...
public class RepositoryServiceImpl extends AbstractBrowserBindingService implements RepositoryService {
    ...
    public void deleteType(String repositoryId, String typeId, ExtensionsData extension) {
        // CRITICAL HTTP REQUEST LOGGING - START
        System.err.println("=== OPENCMIS CLIENT DELETETYPE HTTP REQUEST DEBUG ===");
        System.err.println("Repository ID: " + repositoryId);
        System.err.println("Type ID: " + typeId);
        System.err.println("Extension Data: " + (extension != null ? "NOT NULL" : "NULL"));
        
        // build URL
        UrlBuilder url = getRepositoryUrl(repositoryId);
        System.err.println("Generated URL: " + url.toString());
        ...
        System.err.println("Form Data Parameters:");
        System.err.println("  - cmisaction: " + Constants.CMISACTION_DELETE_TYPE);
        System.err.println("  - " + Constants.CONTROL_TYPE_ID + ": " + typeId);
        System.err.println("Content Type: " + formData.getContentType());
        
        System.err.println("=== SENDING HTTP POST REQUEST ===");
        ...
        postAndConsume(url, formData.getContentType(), new Output() {
            ...
            System.err.println("=== HTTP POST REQUEST COMPLETED SUCCESSFULLY ===");
        } catch (Exception e) {
        ...
        System.err.println("=== OPENCMIS CLIENT DELETETYPE COMPLETED ===");
    }
}
