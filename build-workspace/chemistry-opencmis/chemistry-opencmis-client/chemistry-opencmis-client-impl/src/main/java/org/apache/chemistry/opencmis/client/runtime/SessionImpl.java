...
public class SessionImpl implements Session {
    ...
    public void deleteType(String typeId) {
        ...
        System.err.println("=== SESSION IMPL DELETE TYPE DEBUG ===");
        System.err.println("SessionImpl.deleteType() called for type: " + typeId);
        System.err.println("Repository ID: " + getRepositoryId());
        System.err.println("Binding class: " + getBinding().getClass().getName());
        System.err.println("Repository Service class: " + getBinding().getRepositoryService().getClass().getName());
        System.err.println("About to call binding.getRepositoryService().deleteType()");
