...
mvn -f $SCRIPT_HOME/install-util package
mvn -f $SOURCE_HOME/setup/couchdb/bjornloka package
...
#Prepare WAR
mvn -f $SOURCE_HOME/nemakiware clean
mvn -f $SOURCE_HOME/nemakiware -Dmaven.test.skip=true package
mvn -f $SOURCE_HOME/nemakisolr clean
mvn -f $SOURCE_HOME/nemakisolr -Dmaven.test.skip=true package
...
mvn -f $SOURCE_HOME/nemakiware clean
mvn -f $SOURCE_HOME/nemakisolr clean
mvn -f $SCRIPT_HOME/install-util clean
mvn -f $SOURCE_HOME/setup/couchdb/bjornloka clean
